function clipPic(obj,tar,callback,chow,choh){
...
setTimeout(function(){
    ...
    addEvent("change",function(){getPic(refile);},refile);
    addEvent("change",function(){getPic(file);},file);
